...
CREATE TABLE `tenant` (
    ...
    `phone_mobile` varchar(25) DEFAULT '',
    `phone_office` varchar(25) DEFAULT '',
    `phone_home` varchar(25) DEFAULT '',
    `phone_fax` varchar(25) DEFAULT '',
    `idno` varchar(30) DEFAULT '',
    `reg` varchar(50) DEFAULT '',
    `taxno` varchar(50) DEFAULT '',
    `idtype` varchar(20) DEFAULT '',
    `employer` varchar(60) DEFAULT '',
